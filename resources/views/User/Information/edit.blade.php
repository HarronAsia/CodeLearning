            ...
            <div class="tab-content profile-tab" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <form action="{{ route('information.update',['locale'=>app()->getLocale(),'information'=>$profile->user_id??''])}} " method="POST" enctype="multipart/form-data" id="editprofile">
                        ...
                        <div class="form-group">
                            <i class="fas fa-briefcase"></i> &ensp;<label for="job">Your Job</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="issued_date" placeholder="Enter Your Issued Date" value="{{$profile->issued_date?? ''}}">
                        </div>

                        <div class="form-group">
                            <i class="fas fa-search-location"></i>&ensp;<label for="issued_by">Your Issued By</label>
                            <input type="text" class="form-control" name="issued_by" placeholder="Enter Your Issued By" value="{{$profile->issued_by?? ''}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="window_live_link" placeholder="Enter Window Live link" value="{{$profile->window_live_link?? ''}}">
                        </div>

                        <div class="form-group">
                            <i class="fab fa-yahoo"></i>&ensp;<label for="yahoo_link">Your Yahoo link </label>
                            <input type="text" class="form-control" name="yahoo_link" placeholder="Enter Yahoo link" value="{{$profile->yahoo_link?? ''}}">
                        </div>

                        <div class="form-group">
                            <i class="fas fa-phone"></i>&ensp;<label for="icq_link">Your ICQ link </label>
                            <input type="text" class="form-control" name="icq_link" placeholder="Enter ICQ link" value="{{$profile->icq_link?? ''}}">
                        </div>

                        <div class="form-group">
                            <i class="fab fa-skype"></i>&ensp;<label for="skype_link">Your Skype link </label>
                            <input type="text" class="form-control" name="skype_link" placeholder="Enter Skype link" value="{{$profile->skype_link?? ''}}">
                        </div>

                        <div class="form-group">
                            <i class="fab fa-google"></i>&ensp;<label for="google_talk_link">Your Google Talk link </label>
                            <input type="text" class="form-control" name="google_talk_link" placeholder="Enter Google Talk link" value="{{$profile->google_talk_link?? ''}}">
                        </div>

                        <div class="form-group">
                            <i class="fab fa-facebook-f"></i>&ensp;<label for="facebook_link">Your Facebook link </label>
                            <input type="text" class="form-control" name="facebook_link" placeholder="Enter Facebook link" value="{{$profile->facebook_link?? ''}}">
                        </div>

                        <div class="form-group">
                            <i class="fab fa-twitter"></i>&ensp;<label for="twitter_link">Your Twitter link </label>
                            <input type="text" class="form-control" name="twitter_link" placeholder="Enter Twitter link" value="{{$profile->twitter_link?? ''}}">
                        </div>

                        <div class="form-group">
                            <i class="fas fa-info"></i>&ensp;<label for="detail">Your Detail </label> <br>
                            <textarea name="detail" id="detail" cols="96" rows="20" placeholder="Enter Your Bio Detail">{{$profile->detail?? ''}}</textarea>
                        </div>
